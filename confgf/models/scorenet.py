...
class EquiDistanceScoreMatch(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        config_path = "/home/snirhordan/reproduce-welnet/confgen/confgf/layers/DisGNN/config/{}_{}_3_blocks_256_72.yaml".format(model_name, dataset_name) #TODO ERASE NAMES!
